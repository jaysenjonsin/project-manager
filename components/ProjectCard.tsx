...
const ProjectCard: FC<{ project: ProjectWithTasks }> = ({ project }) => {
  ...
  return (
    <Card className='!px-6 !py-8 hover:scale-105 transition-all ease-in-out duration-200'>
      ...
      <div>
        {/* progress bar is just div on top of div: the length of the progress div is determined by progress. had to make seperate div bc cannot do calculatons in tailwind */}
